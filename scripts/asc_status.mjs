#!/usr/bin/env node
// Read-only App Store Connect status for RUNG: versions + review submissions
// (with how long the current submission has been waiting). No writes.
import crypto from "node:crypto";

const apiBase = "https://api.appstoreconnect.apple.com/v1";
const bundleId = process.env.BUNDLE_ID || "com.colecantcode.rung";
